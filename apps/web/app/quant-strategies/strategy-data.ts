...
export const QUANT_STRATEGIES: QuantStrategy[] = [
  {
    ...
    logic: [
      ...
      "持有 20 個交易日，下一輪重新排序；目前第一期不換股、不追修參數。",
    ],
    sizing: [
    ...
    riskControls: [
      ...
      "單檔風險會標示，但第一期強制線是籃子層級。",
      "不做盤中追價與參數重調。",
    ],
    caveats: [
      "5/14 籃子 -7.17%，未觸發籃子警示；6205 單檔 -15.73% 已物化。",
      "歷史共同窗數字與現在前瞻觀察是不同證據層，不混在一起宣告。",
    ],
    metrics: {
      netReturnPct: 400.89,
      benchmarkPct: 95.25,
    ...
    current: {
      asOf: "2026-05-14",
      status: "觀察第 6 / 20 日",
      primaryReadout: "第一期籃子 -7.17%",
      secondaryReadout: "0050 +0.31%，超額 -7.49 百分點",
    },
    holdings: [
      { symbol: "3707", weight: 0.25, price: 80.0, note: "觀察第 6 日 +9.44%" },
      { symbol: "2426", weight: 0.25, price: 66.8, note: "觀察第 6 日 -12.34%" },
      { symbol: "6205", weight: 0.25, price: 79.3, note: "觀察第 6 日 -15.73%" },
      { symbol: "2486", weight: 0.25, price: 259.0, note: "觀察第 6 日 -10.07%" },
    ],
    curve: [
  ...
  },
  {
    ...
    caveats: [
      ...
      "5/14 已抓到 20 / 20 收盤錨點，前瞻觀察可以從 SIM 層先跑。",
    ],
    metrics: {
      netReturnPct: 303.73,
      excessPct: 45.91,
    ...
    current: {
      asOf: "2026-05-14",
      status: "20 / 20 收盤錨點已完成",
      primaryReadout: "最新觀察期 2026-04",
      secondaryReadout: "規則：營收年增加速度 Top 20",
    },
  ...
  },
  {
    ...
    logic: [
      ...
      "借券量相對成交量的風險特徵作為覆蓋層，不把它當成單一 alpha 來源。",
      "目前只有 6 個歷史特徵日期，因此定位是第三策略備選與風險分散來源。",
    ],
    sizing: [
      "目標 20 檔等權；目前 5/14 收盤錨點只抓到 6 檔真實收盤。",
    ...
    riskControls: [
      "特徵日期數未達 12 前不做主策略宣告。",
      "留一日期檢驗仍脆弱，必須持續擴歷史樣本。",
      "借券覆蓋層只做風險調整，不直接作為唯一買進理由。",
    ],
    caveats: [
      "目前資料完整度低於 Class5；適合先做 SIM 觀察，不適合當唯一主線。",
      "5/14 收盤錨點只有 6 / 20，等隔日 FinMind/TWSE 補齊。",
    ],
    metrics: {
      netReturnPct: 11.94,
      excessPct: 2.2,
      sharpe: null,
      sharpeLabel: "待 12+ 特徵日期",
      maxDrawdownPct: -0.02,
      hitRatePct: 60.0,
      sampleCount: 5,
    },
    current: {
      asOf: "2026-05-14",
      status: "6 / 20 收盤錨點",
      primaryReadout: "相對基準增益 +13.97 百分點",
      secondaryReadout: "留一檢驗最低超額 -0.93 百分點",
    },
    holdings: [
      { symbol: "3118", weight: 1 / 6, price: 33.85, note: "Family C 錨點排序第 4" },
      { symbol: "1558", weight: 1 / 6, price: 90.5, note: "Family C 錨點排序第 9" },
      { symbol: "1591", weight: 1 / 6, price: 52.7, note: "Family C 錨點排序第 11" },
      { symbol: "3325", weight: 1 / 6, price: 12.05, note: "Family C 錨點排序第 12" },
      { symbol: "6164", weight: 1 / 6, price: 11.85, note: "Family C 錨點排序第 13" },
      { symbol: "3095", weight: 1 / 6, price: 44.4, note: "Family C 錨點排序第 15" },
    ],
    curve: [
