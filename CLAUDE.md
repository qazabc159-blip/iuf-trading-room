# IUF Trading Room — 工程操作手冊（repo 級，2026-07-03 Fable 5 立）

台股 AI 交易戰情室。北極星：把散落的操盤工作流變成可追蹤、可執行、可檢討的投資作業系統 — **不是財經資訊網站**。產品地圖見 `reports/PRODUCT_MAP_2026_07.md`。優先序：Claude Code session 讀 owner memory `board/roadmap_2026h2.md`；其他代理（Codex 等）由派工訊息取得，沒給就只做被指派的事＋守本檔鐵律。（本檔與 AGENTS.md 除開頭代理註記外同內容，改一份必同步另一份。）
